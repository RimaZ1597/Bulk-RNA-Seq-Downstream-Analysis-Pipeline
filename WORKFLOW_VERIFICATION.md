...
All components have been updated according to your specifications. The pipeline now implements the exact fixed workflow you requested with no optional steps.