...
├── ⚙️ nextflow.config            # Global pipeline configuration
├── 📋 requirements.txt           # Python dependencies
├── 🧬 subsystem_genes.csv        # HumanGEM pathway gene mappings
├── 🔧 analysis_config.yaml       # Analysis configuration (generated by setup.py)
├── 🧪 run_pipeline_test.sh       # Pipeline testing script
├── 📚 WORKFLOW_VERIFICATION.md   # Workflow validation documentation
│
├── 📂 bin/                       # R analysis scripts
│   ├── combat_seq.R              # ComBat-seq batch correction
│   ├── limma.R                   # limma-voom differential expression
│   ├── pathway_analysis.R        # FGSEA pathway enrichment
│   ├── power_analysis.R          # RNASeqPower statistical analysis
│   └── README.md                 # Scripts documentation
│
├── 📂 conf/                      # Configuration files
│   ├── nextflow.config           # Main Nextflow configuration
│   ├── modules.config            # Module-specific settings
│   ├── api_config.yml           # External API configurations
│   └── README.md                 # Configuration documentation
│
├── 📂 data/                      # Input datasets and results
│   ├── PLX182687/               # Example: Shear stress experiment
│   ├── PLX007704/               # Additional experimental datasets
│   ├── PLX060659/               # More datasets...
│   └── README.md                 # Data organization guide
│
├── 📂 interactive_setup/         # Configuration wizard
│   ├── setup.py                 # Interactive configuration generator
│   ├── utils_io.py             # Input/output utilities
│   ├── utils_pluto.py          # Pluto.jl integration
│   ├── data/                   # Sample datasets for wizard testing
│   └── README.md                 # Setup documentation
│
├── 📂 modules/local/             # Nextflow DSL2 modules
│   ├── combat_seq/              # ComBat-seq module
│   ├── limma/                   # limma-voom module
│   ├── pathway_analysis/        # Pathway analysis module
│   ├── power_analysis/          # Power analysis module
│   └── README.md                 # Module documentation
│
├── 📂 workflows/                 # Nextflow workflow definitions
│   ├── combatseq.nf             # Batch correction workflow
│   ├── limma.nf                 # Differential expression workflow
│   ├── pathway_analysis.nf      # Pathway enrichment workflow
│   ├── rnaseqpower.nf          # Power analysis workflow
│   └── README.md                 # Workflow documentation
│
└── 📂 work/                      # Nextflow execution cache (auto-generated)
```
...
```
combatseq/
├── combatseq_corrected_counts.csv    # Batch-corrected expression matrix
├── combatseq_original_counts.csv     # Filtered original counts
├── combatseq_metadata.csv           # Aligned sample metadata
└── combatseq_log.txt               # Analysis log and QC metrics
```

### Differential Expression Output
```
limma/
├── analysis_summary.csv              # Summary statistics across contrasts
├── all_contrasts_combined_results.csv # All DE results combined
├── normalized_counts_cpm.csv         # TMM-normalized CPM values
├── voom_log2cpm.csv                 # Voom-transformed expression
└── {CONTRAST_NAME}/                  # Per-contrast results
    ├── all_genes_results.csv        # Complete DE results (no filtering)
    ├── significant_genes.csv        # FDR < 0.05 genes only
...
pathway_analysis/
└── {CONTRAST_NAME}/
    ├── ranked_gene_list.csv          # Genes ranked by significance
    ├── humangem_subsystem_pathways.csv # HumanGEM metabolic pathways
    ├── msigdb_Hallmark_pathways.csv   # Hallmark gene sets
    ├── msigdb_KEGG_pathways.csv      # KEGG pathways
    ├── msigdb_GO_pathways.csv        # Gene Ontology terms
...
```
power_analysis/
├── power_distribution_original.csv      # Power before batch correction
├── power_distribution_corrected.csv     # Power after batch correction
...
```yaml
project_name: "PLX182687_ShearStress"
...
comparisons:
  - "donor_19503_shear_stress_High_vs_Static"
  - "donor_19503_shear_stress_Medium_vs_Static"
  - "donor_19503_vs_21452_shear_stress_High"
...
- **Python ≥ 3.8**: Interactive setup components
...
- **📂 bin/README.md**: R analysis scripts documentation
- **📂 conf/README.md**: Configuration files guide
- **📂 data/README.md**: Data organization and formats
- **📂 interactive_setup/README.md**: Configuration wizard guide
- **📂 modules/local/README.md**: Nextflow modules documentation
- **📂 workflows/README.md**: Workflow definitions guide
...
- ✅ Complete limma-voom integration
- ✅ ComBat-seq batch correction
- ✅ FGSEA pathway analysis
- ✅ RNASeqPower analysis
...
**🧬 Developed for comprehensive downstream bulk RNA-seq analysis with reproducible** 🧬